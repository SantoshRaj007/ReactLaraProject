                    ...
                    <div className='col-md-9'> 
                        <div className='card shadow'>
                            <div className='card-body p-4'>
                                ...
                                {
                                    loader == false && products.length == 0 && <NotFound title="Products Not Found..!!" />
                                }
                                {
                                                ...
                                                products.map((product, index) => {
                                                    return (
                                                        <tr key={index}>
                                                            ...
                                                            <td>
                                                            {
                                                                (product.image_url == "") ? <img src='https://placehold.co/50x50' /> : <img src={product.image_url} alt='product_img' width={50} />
                                                            }
                                                            ...
                                                            <td>
                                                                {
                                                                    product.status == 1 ? <span className='badge text-bg-success'>Active</span>
