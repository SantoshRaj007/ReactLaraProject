            ...
            <div className='container'>
                <div className='row'>
                    <div className='d-flex justify-content-between mt-5 pb-3'>
                        ...
                        <Link to="/admin/brand/create" className='btn btn-primary'>Add Brand</Link>
                    </div>
                    ...
                    <div className='col-md-9'>
                        <div className='card shadow'>
                            <div className='card-body p-4'>
                                ...
                                {
                                    loader == false && brands.length == 0 && <NotFound title="Brands Not Found..!!" />
                                }
                                {
                                                ...
                                                brands.map((brand, index) => {
                                                    return (
                                                        <tr key={`brand-${brand.id}`}>
                                                            ...
                                                            <td>
                                                                <Link to={`/admin/brand/edit/${brand.id}`} className='text-primary'>
