                ...
                <div className='container'>
                    <div className='row mb-5'>
                        <div className='col-md-3 pb-4'>
                            <img src={LogoFooter} alt='logo' width={150} />
                            <div className='pt-3 pe-5'>Lorem, ipsum dolor sit amet consectetur adipisicing edit</div>
                        </div>
                        <div className='col-md-3 pb-4'>
                        ...
                        <div className='col-md-3 pb-4'>
                            ...
                            <ul>
                                <li><Link to=''>+91-98xxxx2163</Link></li>
